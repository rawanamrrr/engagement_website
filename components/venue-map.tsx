...
export default function VenueMap() {
  ...
  const googleMapsUrl = "https://www.google.com/maps/place/diva+garden+mansoura/data=!4m2!3m1!1s0x14f79d22d0788f3b:0x7f150ffd1dab2f47?sa=X&ved=1t:242&ictx=111"
        ...
        <div className="relative group">
          ...
          <div className="relative w-full aspect-video min-h-[250px] rounded-2xl overflow-hidden border-2 border-accent/20 shadow-2xl transition-all duration-300 transform hover:scale-[1.02] cursor-pointer bg-slate-50">
            ...
            <div 
              ...
              role="button"
              tabIndex={0}
              aria-label="Open Diva Garden location in Google Maps"
              onKeyDown={(e) => {
            ...
            >
              ...
              <Image
                src={staticMapUrl}
                alt="Diva Garden Location - Click to open in Google Maps"
                fill
          ...
          <div className="mt-6 text-center px-4">
            <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground mb-2">Diva Garden</h3>
